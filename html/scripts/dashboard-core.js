        ...
        (function (Telemetry) {
            ...
            var Dashboard = (function () {
                ...
                Dashboard.prototype.initializeHub = function () {
                    console.log('initializeHub');
                    //$.connection.hub.logging = false;
                    //$.connection.hub.url = Telemetry.Configuration.getUrl('/signalr');
                    if ("WebSocket" in window) {
                        this.ets2TelemetryHub = new WebSocket('ws://localhost:20211/');//$.connection['ets2TelemetryHub'];
                        this.ets2TelemetryHub.onopen = function() {
                ...
                Dashboard.prototype.connectToHub = function () {
                    ...
                    this.ets2TelemetryHub.onmessage = function(event) {
                        console.log('Received message');
                        _this.dataUpdateCallback(event.data);
                    };
